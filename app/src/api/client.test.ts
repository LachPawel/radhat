...
import { mockHealth, mockDeposits, mockCreateDeposit, mockRouteResponse } from '../test/mocks/handlers';
...
describe('API Client', () => {
  ...
  describe('createDeposit', () => {
    it('should create a new deposit address', async () => {
      const result = await api.createDeposit({ user: '0x1234567890123456789012345678901234567890' });
